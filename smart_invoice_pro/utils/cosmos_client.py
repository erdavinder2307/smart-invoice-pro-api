...
quotes_container = get_container("quotes", "/customer_id")
recurring_profiles_container = get_container("recurring_profiles", "/customer_id")
sales_orders_container = get_container("sales_orders", "/customer_id")
vendors_container = get_container("vendors", "/vendor_id")
